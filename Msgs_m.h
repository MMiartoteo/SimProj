...
class ManagerMsg : public ::cMessage
{
  ...
  public:
    ...
    virtual PeerPtr& getManager();
    virtual const PeerPtr& getManager() const {return const_cast<ManagerMsg*>(this)->getManager();}
    virtual void setManager(const PeerPtr& manager);
...
class LookupMsg : public ::cMessage
{
  ...
  public:
    ...
    // field getter/setter methods
    virtual PeerPtr& getSender();
    virtual const PeerPtr& getSender() const {return const_cast<LookupMsg*>(this)->getSender();}
    virtual void setSender(const PeerPtr& sender);
    virtual double getX() const;
    virtual void setX(double x);
    virtual int getHops() const;
    virtual void setHops(int hops);
